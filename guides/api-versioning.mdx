...
description: "Learn how the Firma Partner API handles versioning, deprecation, and breaking changes"
icon: "code-branch"
---

# API Versioning Guide

The Firma Partner API uses header-based versioning via the `X-API-Version` header. This approach allows clients to specify which API version they want to use, with automatic deprecation warnings and a structured sunset process.
...
Link: <https://docs.firma.dev/api/migration-v1-to-v2>; rel="deprecation"
```
...
| `Link` | URL to migration documentation (when available) |
...
2. **Clients receive warning headers** for a recommended 6-month deprecation period
...
Stay informed about upcoming changes by subscribing to our changelog or API announcements. This gives you advance notice of:
...
<Card title="Complete Setup Guide" icon="book" href="/guides/complete-setup-guide">
  Get started with the Firma Partner API
</Card>
...
<Card title="API Reference" icon="code" href="/api-reference/v01.01.00/company/get-company-information">
