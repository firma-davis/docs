...
> TODO: Add postMessage event schema and example code snippets.
...
- Keep embed tokens short-lived (1–2 hours recommended).
- Validate message origins in your postMessage listeners.
- Scope the JWT token to the specific template and operations needed (read/write as required).

## Next steps

- Add example SDK wrappers for common stacks (React/Vue) if you want a reusable integration component.
- If you want, I can add a concrete postMessage event catalogue matching the editor's real payloads — provide the editor's event names or I can propose a full spec.
