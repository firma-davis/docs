...
```bash
curl -X POST https://api.firma.dev/functions/v1/signing-request-api/v01.03.00/company/domains \
...
```bash
curl -X POST https://api.firma.dev/functions/v1/signing-request-api/v01.03.00/company/domains/{domain_id}/verify-ownership \
  -H "Authorization: YOUR_API_KEY"
```
...
```bash
curl -X POST https://api.firma.dev/functions/v1/signing-request-api/v01.03.00/company/domains/{domain_id}/finalize \
  -H "Authorization: YOUR_API_KEY"
```
...
```bash
curl -X POST https://api.firma.dev/functions/v1/signing-request-api/v01.03.00/company/domains/{domain_id}/verify-dns \
  -H "Authorization: YOUR_API_KEY"
```
...
```bash
curl -X POST https://api.firma.dev/functions/v1/signing-request-api/v01.03.00/company/domains/{domain_id}/set-primary \
  -H "Authorization: YOUR_API_KEY"
```
...
```bash
curl -X POST https://api.firma.dev/functions/v1/signing-request-api/v01.03.00/workspaces/{workspace_id}/domains \
  -H "Authorization: YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
📘 See the [Email Domains API Reference](/api-reference/v01.03.00/email-domains/list-company-domains) for complete endpoint documentation.
...
```bash
curl -X POST https://api.firma.dev/functions/v1/signing-request-api/v01.03.00/signing-requests \
  -H "Authorization: YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
const response = await fetch(
  'https://api.firma.dev/functions/v1/signing-request-api/v01.03.00/signing-requests',
  {
    method: 'POST',
    headers: {
...
const usersResponse = await fetch(
  `https://api.firma.dev/functions/v1/signing-request-api/v01.03.00/signing-requests/${signingRequest.id}/users`,
  {
...
```js
const workspace = await fetch('https://api.firma.dev/functions/v1/signing-request-api/v01.03.00/workspaces', {
  method: 'POST',
  headers: {
    'Authorization': API_KEY,
    'Content-Type': 'application/json'
...
const domainResponse = await fetch(
  `https://api.firma.dev/functions/v1/signing-request-api/v01.03.00/workspaces/${workspace.id}/domains`,
  {
    method: 'POST',
    headers: {
      'Authorization': API_KEY,
...
await fetch(
  `https://api.firma.dev/functions/v1/signing-request-api/v01.03.00/workspaces/${workspace.id}/domains/${domainId}/verify-ownership`,
  { method: 'POST', headers: { 'Authorization': API_KEY } }
)

// Step 4: Finalize (returns SPF, DKIM, DMARC records)
const finalizeResponse = await fetch(
  `https://api.firma.dev/functions/v1/signing-request-api/v01.03.00/workspaces/${workspace.id}/domains/${domainId}/finalize`,
  { method: 'POST', headers: { 'Authorization': API_KEY } }
).then(r => r.json())
...
// Step 6: Verify DNS
await fetch(
  `https://api.firma.dev/functions/v1/signing-request-api/v01.03.00/workspaces/${workspace.id}/domains/${domainId}/verify-dns`,
  { method: 'POST', headers: { 'Authorization': API_KEY } }
)

// Step 7: Set as primary
await fetch(
  `https://api.firma.dev/functions/v1/signing-request-api/v01.03.00/workspaces/${workspace.id}/domains/${domainId}/set-primary`,
  { method: 'POST', headers: { 'Authorization': API_KEY } }
)
```
