...
Use [`comprehensive-update-signing-request`](../api-reference/v01.00.02/signing-requests/comprehensive-update-signing-request) for complex updates involving multiple sections.
...
- [Add automated reminders](../api-reference/v01.00.02/signing-requests/get-signing-request-reminders) for pending recipients
