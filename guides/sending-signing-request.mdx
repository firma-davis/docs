...
Use [`comprehensive-update-signing-request`](../api-reference/signing-requests/comprehensive-update-signing-request) for complex updates involving multiple sections.
...
Use [`partially-update-signing-request`](../api-reference/signing-requests/partially-update-signing-request) when updating specific properties or a single recipient.
