...
Use [`comprehensive-update-signing-request`](../api-reference/v01.03.00/signing-requests/comprehensive-update-signing-request) for complex updates involving multiple sections.
...
Use [`partially-update-signing-request`](../api-reference/v01.03.00/signing-requests/partially-update-signing-request) when updating specific properties or a single recipient.
...
- [Add automated reminders](../api-reference/v01.03.00/signing-requests/get-signing-request-reminders) for pending recipients
