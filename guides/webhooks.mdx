...
- [Create a webhook](../api-reference/v01.01.00/webhooks/create-webhook) via API
- [Test your webhook](../api-reference/v01.01.00/webhooks/test-a-webhook) before going live
- [Update webhook settings](../api-reference/v01.01.00/webhooks/update-webhook) as needed