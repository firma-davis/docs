...
<Note>
**Rate limit**: Webhook endpoints support **60 requests per minute per API key**.
...
- [Create a webhook](../api-reference/v01.00.01/webhooks/create-webhook) via API
- [Test your webhook](../api-reference/v01.00.01/webhooks/test-a-webhook) before going live
- [Update webhook settings](../api-reference/v01.00.01/webhooks/update-webhook) as needed