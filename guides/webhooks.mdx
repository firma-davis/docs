...
- [Create a webhook](../api-reference/v01.00.02/webhooks/create-webhook) via API
- [Test your webhook](../api-reference/v01.00.02/webhooks/test-a-webhook) before going live
- [Update webhook settings](../api-reference/v01.00.02/webhooks/update-webhook) as needed