...
You can also find dedicated reference pages under `api-reference/v01.00.01/workspaces`:

- `api-reference/v01.00.01/workspaces/create-a-new-workspace`
- `api-reference/v01.00.01/workspaces/list-workspaces`
- `api-reference/v01.00.01/workspaces/update-a-workspace`
...
- [Configure workspace settings](workspace-settings) for custom email templates and timezone (100-200 req/min)
