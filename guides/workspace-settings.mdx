...
- [List Workspaces](../api-reference/v01.03.00/workspaces/list-workspaces) — Get all workspaces (100 req/min)
- [Create Workspace](../api-reference/v01.03.00/workspaces/create-a-new-workspace) — Create new workspace (100 req/min)
- [Update Workspace](../api-reference/v01.03.00/workspaces/update-a-workspace) — Update workspace details (100 req/min)

### Workspace Settings

- [Get Workspace Settings](../api-reference/v01.03.00/workspace-settings/get-workspace-settings) — Retrieve current settings (200 req/min)
- [Update Workspace Settings](../api-reference/v01.03.00/workspace-settings/update-workspace-settings) — Update email templates and preferences (100 req/min)

### Related Endpoints

- [Generate JWT Token](../api-reference/v01.03.00/jwt-management/generate-jwt-token) — For embedded template editor (120 req/min)
- [Create Template](../api-reference/v01.03.00/templates/create-template) — Create templates per workspace (100 req/min)
- [Create Signing Request](../api-reference/v01.03.00/signing-requests/create-signing-request) — Send documents with workspace branding (100 req/min)
