...
<Note>
**For secure embedded workflows**: Use [JWT authentication](embeddable-template-editor#jwt-authentication) to generate time-limited access tokens. JWT endpoints support **120 requests per minute per API key**.
</Note>
