...
📘 [Workspace Settings Guide](/guides/workspace-settings)
...
If you would rather let users configure who the document goes to and how it is sent using a UI instead of building the JSON payload yourself, you can embed the signing request editor in your product.
...
- The user fills in signer details (names, emails, roles) and any allowed options such as expiration or message.
...
Embed the signing flow within your app for a seamless user experience. This is ideal if you're building a white-labeled or fully-integrated product.
